...
export const chtFontFace = "Microsoft JhengHei"
// const chsFontFace = "Microsoft YaHei"
export const chsFontFace = "Microsoft JhengHei"
export const enFontFace = "Arial";
// TODO: make lyrics font size configurable
export const coverFontSizeChPri = 60;
export const coverFontSizeChSec = 40;
export const coverFontSizeEnPri = 48;
export const coverFontSizeEnSec = 36;
export const lyricsFontSizeChPri = 40;
export const lyricsFontSizeChSec = 28;
export const lyricsFontSizeEnPri = 32;
export const lyricsFontSizeEnSec = 24;
export const lyricsFontSizeChPriSmaller = 36;
export const lyricsFontSizeChSecSmaller = 24;
export const lyricsFontSizeEnPriSmaller = 28;
export const lyricsFontSizeEnSecSmaller = 20;
export const lyricsFontSizeChPriSmallest = 32;
export const lyricsFontSizeChSecSmallest = 20;
export const lyricsFontSizeEnPriSmallest = 24;
export const lyricsFontSizeEnSecSmallest = 18;
export const footerFontSize = 12;
export const blankLineHeight = 10;
